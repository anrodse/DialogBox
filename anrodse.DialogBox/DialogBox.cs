...
namespace anrodse.Forms
{
	public class DialogBox
	{
		...
		public static DialogBoxResult Show(string text, string caption = "", DialogBoxButtons buttons = DialogBoxButtons.Ok, DialogBoxIcon icon = DialogBoxIcon.None, MessageBoxDefaultButton defaultButton = MessageBoxDefaultButton.Button1, int timeOut = 0, DialogBoxTimeoutResult timeoutResult = DialogBoxTimeoutResult.Timeout, int disable = 0)
